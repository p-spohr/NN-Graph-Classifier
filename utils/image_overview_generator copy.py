...
file_name = f"{GRAPH_DIST[INDEX_DIST]}_{GRAPH_DIM[INDEX_DIM]}_overview"
save_path = f"C:\\Users\\pat_h\\OneDrive\\Desktop\\public-repos\\NN-Graph-Classifier\\presentation\\images\\overviews\\{file_name}"

plt.suptitle(f'{GRAPH_DIST[INDEX_DIST].capitalize()} Distributions {GRAPH_DIM[INDEX_DIST]}', fontsize=15.0, y=0.95)
